...
/// avoid memory leak.
const SherpaOnnxDisplay *SherpaOnnxCreateDisplay(
...
void SherpaOnnxDestroyOfflineStream(
...
void SherpaOnnxDestroyKeywordSpotter(
...
void SherpaOnnxDestroyKeywordResult(
...
// pointer to avoid memory leak.
const float *SherpaOnnxCircularBufferGet(
...
// If the returned pointer is not NULL, the user has to invoke
// SherpaOnnxFreeWave() to free the returned pointer to avoid memory leak.
const SherpaOnnxWave *SherpaOnnxReadWaveFromBinaryData(
...
// to free the returned pointer to avoid memory leak
const SherpaOnnxAudioEvent *const *
...
void SherpaOnnxDestroyOnlinePunctuation(
...
void SherpaOnnxDestroyLinearResampler(
    const SherpaOnnxLinearResampler *p);

void SherpaOnnxLinearResamplerReset(
    const SherpaOnnxLinearResampler *p);
...
void SherpaOnnxLinearResamplerResampleFree(
